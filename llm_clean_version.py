...
TOOLS = [search_products, search_faqs, respond_to_user]
...
def generate_final_response(context: Dict[str, Any], prompt_template: str) -> Dict[str, Any]:
    ...
    if final_response_object and final_response_object.candidates:
        ...
        if part.function_call:
            ...
            # MODE 1 REMOVED: Force LLM to always use final_response tool
        ...
        if latest_interaction:
            ...
            if all_completed:
                ...
                if response_type == "function_assisted":
                    ...
                    # Note: else branch removed - Mode 1 no longer supported
                else:
